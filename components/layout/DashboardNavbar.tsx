        ...
        <header className="h-20 bg-[#171D25] border-b border-[#333]">
            <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-6">
                ...
                <div className="relative">
                    <button onClick={() => setOpen(!open)} className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-zinc-800 transition">
                    ...
                    {open && (
                        <div className="absolute right-0 top-full mt-2 z-50 w-48 rounded-lg border border-[#333] bg-[#171D25] shadow-xl p-2">
                            <button onClick={logout} className="w-full text-left px-3 py-2 rounded-md hover:bg-zinc-800 transition">
                                Logout
                            </button>
                        </div>
                    )}
